...
//        Assert.assertEquals(expected,result);
    ...
    public void testUpdateArticle() throws Exception {
        String url = "https://qs.teckbote.de/atex/REST/backend/module/ar/baf77816-a247-478b-b834-3609cb23331d";
    ...
    public void testGetArticle() throws Exception {
        String url = "https://qs.teckbote.de/atex/REST/backend/module/ar/bbj77816-a247-478b-b834-3609cb23331d";
...
//	    ra.getParams().add(new BasicNameValuePair("name", "redFACT"));
        ...
        ra.getParams().add(new BasicNameValuePair("description", "stephan")); // 200
